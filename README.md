...
- /api/v1/pessoa Cria uma Pessoa nova [POST]
- /api/v1/pessoa/{id} Retorna os dados de uma Pessoa criada [DELETE]
- /api/v1/pessoa/{id} Atualiza os dados de uma Pessoa  [PUT]
- /api/v1/pessoa/{id} Exclui uma Pessoa [DELETE]
